						...
						<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
							<div class="main-content text-center">
								<div class="img-wrap text-center">
									<img src="{{asset('forntend/img/vertical_line.png')}}" alt="">
				...
				<div class="container">
					<div class="row c-mb-50 c-mb-md-60">
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="vertical-item text-center">
								<div class="item-media">
									<img src="{{asset('forntend/images/service/service_icon_1-1.png')}}" alt="">
								</div>
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="vertical-item text-center">
								<div class="item-media">
									<img src="{{asset('forntend/images/service/service_icon_2-1.png')}}" alt="">
								</div>
								<div class="item-content">
									<h6>
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="vertical-item text-center">
								<div class="item-media">
									<img src="{{asset('forntend/images/service/service_icon_3-1.png')}}" alt="">
								</div>
								<div class="item-content">
									<h6>
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="vertical-item text-center">
								<div class="item-media">
									<img src="{{asset('forntend/images/service/service_icon_4-1.png')}}" alt="">
								</div>
								<div class="item-content">
									<h6>
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="vertical-item text-center">
								<div class="item-media">
									<img src="{{asset('forntend/images/service/service_icon_5-1.png')}}" alt="">
								</div>
								<div class="item-content">
									<h6>
						...
						<div class="col-12 col-md-6 col-lg-4">
							<div class="vertical-item text-center">
								<div class="item-media">
									<img src="{{asset('forntend/images/service/service_icon_6-1.png')}}" alt="">
								</div>
								<div class="item-content">
									<h6>
				...
				<div class="container">
					...
					<div class="row align-items-center c-mb-20 c-mb-lg-60">
						...
						<div class="col-12 col-lg-4">
							<div class="step-center-part text-center">
								<img src="{{asset('forntend/images/step_img_1.jpg')}}" alt="">
							</div>
						</div>
						<div class="col-12 col-lg-4">
					...
					<div class="row align-items-center right c-mb-20 c-mb-lg-60">
						...
						<div class="col-12 col-lg-4 order-lg-2">
							<div class="step-center-part text-center">
								<img src="{{asset('forntend/images/step_img_2.jpg')}}" alt="">
							</div>
						</div>
					...
					<div class="row align-items-center c-mb-20 c-mb-lg-60">
						...
						<div class="col-12 col-lg-4">
							<div class="step-center-part text-center">
								<img src="{{asset('forntend/images/step_img_3.jpg')}}" alt="">
							</div>
						</div>
						<div class="col-12 col-lg-4">
							<div class="step-right-part">
					...
					<div class="divider-10 d-block d-sm-none"></div>
					<div class="img-wrap text-center">
						<img src="{{asset('forntend/img/vertical_line2.png')}}" alt="">
					</div>
						...
						<div class="col-lg-12">
							...
							<div class="owl-carousel gallery-owl-nav" data-autoplay="false" data-responsive-lg="5" data-responsive-md="3" data-responsive-sm="3" data-responsive-xs="2" data-nav="true" data-dots="false" data-filters=".gallery-filters" data-margin="0" data-loop="true">
								<div class="vertical-item item-gallery content-absolute text-center ds web-design">
									<div class="item-media">
										<img src="{{asset('forntend/images/gallery/gallery-1.jpg')}}" alt="">
								...
								<div class="vertical-item item-gallery content-absolute text-center ds logo-design">
									<div class="item-media">
										<img src="{{asset('forntend/images/gallery/gallery-2.jpg')}}" alt="">
										<div class="media-links">
								...
								<div class="vertical-item item-gallery content-absolute text-center ds advertisement">
									<div class="item-media">
										<img src="{{asset('forntend/images/gallery/gallery-3.jpg')}}" alt="">
										<div class="media-links">
								...
								<div class="vertical-item item-gallery content-absolute text-center ds branding">
									<div class="item-media">
										<img src="{{asset('forntend/images/gallery/gallery-4.jpg')}}" alt="">
										<div class="media-links">
								...
								<div class="vertical-item item-gallery content-absolute text-center ds design">
									<div class="item-media">
										<img src="{{asset('forntend/images/gallery/gallery-5.jpg')}}" alt="">
										<div class="media-links">
								...
								<div class="vertical-item item-gallery content-absolute text-center ds photo">
									<div class="item-media">
										<img src="{{asset('forntend/images/gallery/gallery-6.jpg')}}" alt="">
										<div class="media-links">
				...
				<div class="container">
					...
					<div class="row c-mb-50 c-mb-lg-0">
						...
						<div class="col-lg-4 text-center">
							...
							<p>
								<a href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="23465b424e534f4663465b424e534f460d404c4e">[email&#160;protected]</a>
								<br> <a href="https://html.modernwebtemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b4d1ccd5d9c4d8d1f4d1ccd5d9c4d8d19ad7dbd9">[email&#160;protected]</a>
							</p>
						</div>
						<div class="col-lg-4 text-center">
							<div class="border-icon">
